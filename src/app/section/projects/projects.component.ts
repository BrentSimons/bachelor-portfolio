...
export class ProjectsComponent implements OnInit {
  ...
  public readonly categories: Category[] = [...new Set(projects.map(p => p.category))]; // Extract unique categories
  ...
  protected filterProjects(): void {
    if (this.categoryFilter) {
      this.filteredProjects = this.projects.filter(project => project.category === this.categoryFilter);
    } else {
      this.filteredProjects = this.projects;
    }
  }
